...
private TableRowSorter trsfiltro;
   ...
   //tomamos lo que se escribio
    ...
    private void initComponents() {
        ...
        jButton2.setText("Guardar Codigo");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
      //creamos un archivo dentro de un proyecto Java
          File archivo;
           FileWriter fw = null;
          try {
            archivo= new File("C:\\Users\\raagu\\Documents\\NetBeansProjects\\JavaApplication2\\src\\javaapplication2/NombreArchivo.java");
            
            //si existe este archivo lo elimina  
            if (archivo.exists()) {
                  archivo.delete();
              }
            ...
            //crea el archivo
              if (archivo.createNewFile()) {
               ...
               fw = new FileWriter(archivo);
                ...
                //dividimos el txt por lineas 
                String [] lineas = elresul.split("\n");
              
               
               
               //por cada linea lo va escribiendo en el archivo java 
                 for (int i = 0; i < lineas.length; i++) {
            ...
            try {
              ...
              //cuando finaliza las lineas cierra el bufferWriter
                      bw.close();
